...
from automated_actions.utils.aws_api import AWSApi, get_aws_credentials
from automated_actions.utils.external_resource import (
    ExternalResource,
...
def external_resource_rds_reboot(
    ...
    aws_api = AWSApi(credentials=credentials, region=rds.region)
